...
public:
    LaneProcessingNode() : 
        ...
        last_angle_(0.0), 
        last_distance_(0.0),
        errors_{puzzle_pkg::msg::DiffError{}}
        {
        ...
        publisher_errors_ = this->create_publisher<puzzle_pkg::msg::DiffError>("errors", 10);
...
private:
    ...
    rclcpp::Publisher<puzzle_pkg::msg::DiffError>::SharedPtr publisher_errors_;
